...
Because [this project](https://github.com/azafred/homelab) applies GitOps practices,
it's the source of truth for _my_ homelab, so you'll need to fork it to make it yours:

[:fontawesome-solid-code-fork: Fork azafred/homelab](https://github.com/azafred/homelab/fork){ .md-button }
